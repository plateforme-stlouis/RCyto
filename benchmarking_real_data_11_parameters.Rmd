...
subtitle: "Experience `real_03`, sample `003`, downsampled"
output:
  html_document:
    number_sections: yes
    toc: yes
...
author: Anna Guadall
params:
  file: "down_100_ff_real_03_003.fcs"
  labels: "down_100_labels_real_03_003"
  seed: 42
...
cytof_clusterPlot(data = umap_df, xlab = "UMAP_1", ylab = "UMAP_2", point_size = 0.5, labelRepel = T,
                  ...
                  clusterColor = c("darkgoldenrod1", "blue4", "blueviolet", "red", "turquoise", 
                                   ...
                                   "coral1", "cornflowerblue", "yellow", "cyan", "blue",
                                   "darkgrey", "darkmagenta", "deeppink1", "deeppink4", "black"))
```
