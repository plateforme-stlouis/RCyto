...
if (do_tsne == "y"){
  ...
  tsne_map <- cytof_clusterPlot(data = tsne_df, xlab = "tsne_1", ylab = "tsne_2", 
                                    point_size = 0.5, labelRepel = F,
                                    cluster = "labels", sampleLabel = FALSE, labelSize = 0, 
                                    title = paste(params$id, " Labels"),
                                    clusterColor = coloring[1:(n_pops + as.numeric(params$out))]) 
}
```
...
if (do_umap == "y"){
  ...
  umap_map <- cytof_clusterPlot(data = umap_df, xlab = "UMAP_1", ylab = "UMAP_2", 
                                    point_size = 0.5, labelRepel = F,
                                    cluster = "labels", sampleLabel = FALSE, labelSize = 0, 
                                    title = paste(params$id, " Labels"),
                                    clusterColor = coloring[1:(n_pops + as.numeric(params$out))])
