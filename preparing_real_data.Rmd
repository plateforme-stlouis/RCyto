---
title: "real_02 sample 5 (temoin 4)"
...
```{r, eval = T}
write.FCS(ff, 
          paste(params$condition, "_ff_", params$experience, "_", s, "_", 
                getSamples(ws)[s,"name"], ".fcs", sep = ""))
```

## Save the labels and meta-labels
```{r, eval = T}
saveRDS(data[, "labels"],
        paste(params$condition, "_labels_", params$experience, "_", s, "_", 
              getSamples(ws)[s,"name"], sep = "")) 
saveRDS(data[, "metalabels"],
        paste(params$condition, "_metalabels_", params$experience, "_", s, "_", 
              getSamples(ws)[s,"name"], sep = "")) 
```
